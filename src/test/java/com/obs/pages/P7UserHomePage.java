...
import com.obs.tests.T1LoginTest;

public class P7UserHomePage  {
	
	Logger log = (Logger) LogManager.getLogger(P7UserHomePage.class);
	...
	@FindBy(xpath="//h3[contains(normalize-space(),'Account Number: ')]]")
	...
	public P7UserHomePage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
