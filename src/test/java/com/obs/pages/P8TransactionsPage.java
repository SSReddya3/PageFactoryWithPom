...
public class P8TransactionsPage {
	
	Logger log = (Logger) LogManager.getLogger(P8TransactionsPage.class);
	WebDriver driver;
	ExtentTest test;
	...
	public P8TransactionsPage(WebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
